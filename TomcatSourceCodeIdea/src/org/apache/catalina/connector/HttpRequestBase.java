 ...
 * implement the HTTP protocol. Only the connector-specific methods need to be
 * implemented.
 *
...
public class HttpRequestBase extends RequestBase implements HttpRequest, HttpServletRequest {
	...
	/**
	 * Add a parameter name and corresponding set of values to this Request. (This
	 * is used when restoring the original request on a form based login).
	 *
	...
	/**
	 * Set the authentication type used for this request, if any; otherwise set the
	 * type to <code>null</code>. Typical values are "BASIC", "DIGEST", or "SSL".
	 *
	...
	/**
	 * Set the context path for this Request. This will normally be called when the
	 * associated Context is mapping the Request to a particular Wrapper.
	 *
	...
	/**
	 * Set the path information for this Request. This will normally be called when
	...
	/**
	 * Set the query string for this Request. This will normally be called by the
	...
	/**
	 * Set a flag indicating whether or not the requested session ID for this
	 * request came in through a URL. This is normally called by the HTTP Connector,
	...
	/**
	 * Set the unparsed request URI for this Request. This will normally be called
	...
	/**
	 * Set the servlet path for this Request. This will normally be called when the
	 * associated Context is mapping the Request to a particular Wrapper.
	 *
	...
	/**
	 * Set the Principal who has been authenticated for this Request. This value is
	 * also used to calculate the value to be returned by the
	...
	protected void parseParameters() {
		...
		if ("POST".equals(getMethod()) && (getContentLength() > 0) && (this.stream == null)
			...
			try {
				...
				throw new RuntimeException(sm.getString("httpRequestBase.contentReadFail") + e.getMessage());
			}
		}
	 ...
	 *
	 * @exception IllegalArgumentException if the specified header value cannot be
	 *                                     converted to a date
	 */
	...
	/**
	 * Return all of the values of the specified header, if any; otherwise, return
	...
	/**
	 * Return the value of the specified header as an integer, or -1 if there is no
	 * such header for this request.
	 *
	 * @param name Name of the requested header
	 *
	 * @exception IllegalArgumentException if the specified header value cannot be
	...
	/**
	 * Return the extra path information for this request, translated to a real
	 * path.
	 */
	...
	/**
	 * Return the name of the remote user that has been authenticated for this
	 * Request.
	 */
	 ...
	 * <p>
	 * Because this method returns a <code>StringBuffer</code>, not a
	 * <code>String</code>, you can modify the URL easily, for example, to append
	 * query parameters.
	 * <p>
	...
	/**
	 * Return the portion of the request URI used to select the servlet that will
	...
	/**
	 * Return <code>true</code> if the session identifier included in this request
	 * came from a cookie.
	 */
	...
	/**
	 * Return <code>true</code> if the authenticated user principal possesses the
	 * specified role name.
	 *
